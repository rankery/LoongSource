...
const XmlEncoding TIXML_DEFAULT_ENCODING = TIXML_ENCODING_UTF8;
...
public:
	...
	*/
	...
	virtual const char* Parse(	const char* p, 
								XmlParsingData* data, 
								XmlEncoding encoding /*= TIXML_ENCODING_UNKNOWN */ ) = 0;
...
*/
class VENGINE_API XmlNode : public XmlBase
{
	friend class XmlDocument;
	friend class XmlElement;
...
*/
class VENGINE_API XmlAttribute : public XmlBase
{
...
public:
	...
	const std::string& NameStr() const	{ return name; }				///< Return the value of this attribute.
...
*/
class VENGINE_API  XmlAttributeSet
{
public:
	XmlAttributeSet();
	~XmlAttributeSet();
...
*/
class VENGINE_API XmlElement : public XmlNode
{
public:
...
/**	An XML comment.
*/
class VENGINE_API XmlComment : public XmlNode
{
public:
...
*/
class VENGINE_API XmlText : public XmlNode
{
	friend class XmlElement;
public:
	...
	*/
	...
	XmlText( const XmlText& copy ) : XmlNode( XmlNode::TEXT )	{ copy.CopyTo( this ); }
...
*/
class VENGINE_API XmlDeclaration : public XmlNode
{
public:
...
*/
class VENGINE_API XmlUnknown : public XmlNode
{
public:
...
*/
class VENGINE_API XmlDocument : public XmlNode
{
public:
	...
	bool LoadFile(LPCSTR szVFSName, LPCTSTR szFilename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	...
	*/
	...
	bool LoadFile(LPCSTR szVFSName, tstring& strFilename, XmlEncoding encoding = TIXML_DEFAULT_ENCODING )			///< STL std::string version.
	{
		return LoadFile(szVFSName, strFilename.c_str(), encoding );
	}
	bool SaveFile( const tstring& filename ) const		///< STL std::string version.
	{
...
/** Print to memory functionality. The XmlPrinter is useful when you need to:
	...
	@endverbatim
*/
class VENGINE_API XmlPrinter : public XmlVisitor
{
public:
