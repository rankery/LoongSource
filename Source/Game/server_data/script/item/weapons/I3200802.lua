...
--可否使用函数
function i3200802_CanUse(MapID, InstanceID, TypeID, TargetID)
...
function i3200802_QuestUsable(MapID, InstanceID, TypeID, TargetID)

	local shengchanlingzhuang={}
	shengchanlingzhuang[1] = {OriginalID = 8086090,NewID = 8220010}
	shengchanlingzhuang[2] = {OriginalID = 8096090,NewID = 8220026}
	shengchanlingzhuang[3] = {OriginalID = 8106090,NewID = 8220042}
	shengchanlingzhuang[4] = {OriginalID = 8116090,NewID = 8220058}
	shengchanlingzhuang[5] = {OriginalID = 8126090,NewID = 8220074}
	shengchanlingzhuang[6] = {OriginalID = 8146080,NewID = 8220090}
	shengchanlingzhuang[7] = {OriginalID = 8156090,NewID = 8220098}
	shengchanlingzhuang[8] = {OriginalID = 8166085,NewID = 8220114}
...
--注册
aux.RegisterItemEvent(3200802, 1, "i3200802_QuestUsable")
aux.RegisterItemEvent(3200802, 0, "i3200802_CanUse")]]
