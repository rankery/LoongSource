...
--可否使用函数
function i3200805_CanUse(MapID, InstanceID, TypeID, TargetID)
...
function i3200805_QuestUsable(MapID, InstanceID, TypeID, TargetID)

	local shengchanlingzhuang={}
	shengchanlingzhuang[1] = {OriginalID = 8084090,NewID = 8220001}
	shengchanlingzhuang[2] = {OriginalID = 8094090,NewID = 8220017}
	shengchanlingzhuang[3] = {OriginalID = 8104090,NewID = 8220033}
	shengchanlingzhuang[4] = {OriginalID = 8114090,NewID = 8220049}
	shengchanlingzhuang[5] = {OriginalID = 8124090,NewID = 8220065}
	shengchanlingzhuang[6] = {OriginalID = 8147080,NewID = 8220081}
	shengchanlingzhuang[7] = {OriginalID = 8157090,NewID = 8220105}
	shengchanlingzhuang[8] = {OriginalID = 8167085,NewID = 8220121}
...
--注册
aux.RegisterItemEvent(3200805, 1, "i3200805_QuestUsable")
aux.RegisterItemEvent(3200805, 0, "i3200805_CanUse")]]
