function I1330102_GiftBag(MapID, InstanceID, TypeID, TargetID)
	...
	role.AddRoleItem(MapID, InstanceID, TargetID, 1300002, 2, -1, 8, 420)
end

function I1330102_CanUseGiftBag(MapID, InstanceID, TypeID, TargetID)
...
aux.RegisterItemEvent(1330102, 1, "I1330102_GiftBag")
aux.RegisterItemEvent(1330102, 0, "I1330102_CanUseGiftBag")
