function I3303004_GiftBag(MapID, InstanceID, TypeID, TargetID)
	...
	if i <= 14 then
	    role.AddRoleItem(MapID, InstanceID, TargetID, 1350501, 1, -1, 8, 420)
	elseif i <= 28 then
	    role.AddRoleItem(MapID, InstanceID, TargetID, 1350502, 1, -1, 8, 420)
	elseif i <= 42 then
	    role.AddRoleItem(MapID, InstanceID, TargetID, 1350503, 1, -1, 8, 420)
	elseif i <= 56 then
	    role.AddRoleItem(MapID, InstanceID, TargetID, 1350504, 1, -1, 8, 420)
	elseif i <= 70 then
	    role.AddRoleItem(MapID, InstanceID, TargetID, 1350505, 1, -1, 8, 420)
	elseif i <= 85 then
	    role.AddRoleItem(MapID, InstanceID, TargetID, 1350506, 1, -1, 8, 420)
	elseif i <= 100 then
	    role.AddRoleItem(MapID, InstanceID, TargetID, 1350507, 1, -1, 8, 420)
	end
...
function I3303004_CanUseGiftBag(MapID, InstanceID, TypeID, TargetID)
...
aux.RegisterItemEvent(3303004, 1, "I3303004_GiftBag")
aux.RegisterItemEvent(3303004, 0, "I3303004_CanUseGiftBag")
