function I1330204_GiftBag(MapID, InstanceID, TypeID, TargetID)
...
function I1330204_CanUseGiftBag(MapID, InstanceID, TypeID, TargetID)
...
aux.RegisterItemEvent(1330204, 1, "I1330204_GiftBag")
aux.RegisterItemEvent(1330204, 0, "I1330204_CanUseGiftBag")
