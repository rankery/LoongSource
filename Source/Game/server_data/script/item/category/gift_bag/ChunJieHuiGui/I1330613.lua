function I1330613_GiftBag(MapID, InstanceID, TypeID, TargetID)
	...
	role.AddRoleItem(MapID, InstanceID, TargetID, 1330626, 1, -1, 8, 420)
...
function I1330613_CanUseGiftBag(MapID, InstanceID, TypeID, TargetID)
...
aux.RegisterItemEvent(1330613, 1, "I1330613_GiftBag")
aux.RegisterItemEvent(1330613, 0, "I1330613_CanUseGiftBag")
