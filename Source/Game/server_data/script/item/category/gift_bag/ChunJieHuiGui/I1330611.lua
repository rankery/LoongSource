function I1330611_GiftBag(MapID, InstanceID, TypeID, TargetID)
...
function I1330611_CanUseGiftBag(MapID, InstanceID, TypeID, TargetID)
...
aux.RegisterItemEvent(1330611, 1, "I1330611_GiftBag")
aux.RegisterItemEvent(1330611, 0, "I1330611_CanUseGiftBag")
