...
--怪物死亡
function c1008024_OnDie(MapID, InstanceID, TargetID, TargetTypeID, RoleID)
	Increase_shili(MapID, InstanceID, RoleID, 1, 3, "jinjieshili")

	local xiaoguai_num = map.GetMapScriptData(MapID, InstanceID, 1, 12)
	local Boss_num = map.GetMapScriptData(MapID, InstanceID, 1, 13)+1
...
aux.RegisterCreatureEvent(1008024, 4, "c1008024_OnDie")
