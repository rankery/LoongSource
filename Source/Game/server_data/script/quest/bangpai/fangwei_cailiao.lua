...
function q30005_OnCheckAccept(MapID, InstanceID, QuestID, RoleID, NPCID)
	--判断玩家是否已加入帮派
...
--完成任务
function q30005_OnComplete(MapID, InstanceID, QuestID, RoleID, NPCID)

	if role.GetRoleItemNum(RoleID, 2004001) > 0 then
		role.RemoveFromRole(MapID, InstanceID, RoleID, 2004001, 1, 1000)
	elseif role.GetRoleItemNum(RoleID, 2004002) > 0 then
		role.RemoveFromRole(MapID, InstanceID, RoleID, 2004002, 1, 1000)
	elseif role.GetRoleItemNum(RoleID, 2004003) > 0 then
		role.RemoveFromRole(MapID, InstanceID, RoleID, 2004003, 1, 1000)
	elseif role.GetRoleItemNum(RoleID, 2004004) > 0 then
		role.RemoveFromRole(MapID, InstanceID, RoleID, 2004004, 1, 1000)
	elseif role.GetRoleItemNum(RoleID, 2004007) > 0 then
		role.RemoveFromRole(MapID, InstanceID, RoleID, 2004007, 1, 1000)
	elseif role.GetRoleItemNum(RoleID, 2004008) > 0 then
		role.RemoveFromRole(MapID, InstanceID, RoleID, 2004008, 1, 1000)
	end
	--城市防卫值加10
...
function q30005_OnCheckComplete(MapID, InstanceID, QuestID, RoleID, NPCID)
...
aux.RegisterQuestEvent(30005, 4, "q30005_OnCheckAccept")
aux.RegisterQuestEvent(30005, 1, "q30005_OnComplete")
aux.RegisterQuestEvent(30005, 5, "q30005_OnCheckComplete")
