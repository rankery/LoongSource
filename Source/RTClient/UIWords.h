...
#define w_RemoteTool		wxT("Remote Game Controller")
#define w_OpenCloseServer	wxT("Server Controller")
#define w_GMManager			wxT("GM Manager")
#define w_GoodServerGroup	wxT("Normal Server Group")
...
#define w_ServerName		wxT("Server Type")
...
#define w_MaxOnline			wxT("Max User Online")
